...
var PersonaDetalleComponent = (function () {
    function PersonaDetalleComponent(route, router, service) {
        this.route = route;
        this.router = router;
        this.service = service;
    }
    PersonaDetalleComponent.prototype.getPersona = function (id) {
        var _this = this;
    ...
    PersonaDetalleComponent.prototype.ngOnInit = function () {
        this.persona = new persona_1.Persona();
        var id = this.route.snapshot.paramMap.get('id');
        this.getPersona(+id);
    };
    PersonaDetalleComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
    ...
    return PersonaDetalleComponent;
}());
exports.PersonaDetalleComponent = PersonaDetalleComponent;
