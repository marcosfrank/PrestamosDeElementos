...
var CategoriaEliminarComponent = (function () {
    function CategoriaEliminarComponent(route, router, service) {
        this.route = route;
        this.router = router;
        this.service = service;
    }
    CategoriaEliminarComponent.prototype.getCategoria = function (id) {
        var _this = this;
    ...
    CategoriaEliminarComponent.prototype.delete = function (categoria) {
        var _this = this;
        this.service.delete('Categoria', categoria.Id)
            .then(function () { return _this.router.navigate(['/Categorias/lista']); })
            .catch(function () { return alert('Error al consumir servicio'); });
    };
    CategoriaEliminarComponent.prototype.ngOnInit = function () {
        this.categoria = new categoria_1.Categoria();
        var id = this.route.snapshot.paramMap.get('id');
        this.getCategoria(+id);
    };
    CategoriaEliminarComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
    ...
    return CategoriaEliminarComponent;
}());
exports.CategoriaEliminarComponent = CategoriaEliminarComponent;
