...
var CategoriaCrearComponent = (function () {
    function CategoriaCrearComponent(route, router, service) {
        this.route = route;
        this.router = router;
        this.service = service;
    }
    CategoriaCrearComponent.prototype.save = function (categoria) {
        var _this = this;
    ...
    CategoriaCrearComponent.prototype.ngOnInit = function () {
        this.categoria = new categoria_1.Categoria();
        this.title = 'Crear';
    };
    CategoriaCrearComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
    ...
    return CategoriaCrearComponent;
}());
exports.CategoriaCrearComponent = CategoriaCrearComponent;
